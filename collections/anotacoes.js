Anotacoes = new Mongo.Collection("Anotacoes");

if (Meteor.isServer) {
    //
    Meteor.publish("Anotacoes", function () {
        this.ready()
        return [
            Anotacoes.find({})
        ]
...
Anotacoes.before.insert(function (userId, doc) {
    if (!doc.test) {
...
Anotacoes.before.update(function (userId, doc, fieldNames, modifier, options) {
...
// this.transform() obtains transformed version of document, if a transform was defined.
Anotacoes.before.remove(function (userId, doc) {
    // ...
});
...
Anotacoes.before.upsert(function (userId, selector, modifier, options) {
    // modifier.$set = modifier.$set || {};
    // modifier.$set.modifiedAt = Date.now();
});
...
Anotacoes.after.insert(function (userId, doc) {
    // ...
});
...
Anotacoes.after.update(function (userId, doc, fieldNames, modifier, options) {
    // ...
...
// this.transform() obtains transformed version of document, if a transform was defined.
Anotacoes.after.remove(function (userId, doc) {
    // ...
});
...
Anotacoes.before.find(function (userId, selector, options) {
    // ...
});
...
Anotacoes.after.find(function (userId, selector, options, cursor) {
    // ...
});
...
// Allows you to to adjust selector/options on-the-fly.
Anotacoes.before.findOne(function (userId, selector, options) {
    // ...
});
...
Anotacoes.after.findOne(function (userId, selector, options, doc) {
    // ...
});