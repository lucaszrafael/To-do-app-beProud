AtividadesTarefas = new Mongo.Collection("AtividadesTarefas");

if (Meteor.isServer) {
    //
    Meteor.publish("AtividadesTarefas", function () {
        this.ready()
        return [
            AtividadesTarefas.find({createdBy: this.userId})
        ]
...
AtividadesTarefas.before.insert(function (userId, doc) {
    if (!doc.test) {
        doc.createdAt = MomentBr().toDate()
...
AtividadesTarefas.before.update(function (userId, doc, fieldNames, modifier, options) {
...
// this.transform() obtains transformed version of document, if a transform was defined.
AtividadesTarefas.before.remove(function (userId, doc) {
    // ...
});
...
AtividadesTarefas.before.upsert(function (userId, selector, modifier, options) {
    // modifier.$set = modifier.$set || {};
    // modifier.$set.modifiedAt = Date.now();
});
...
AtividadesTarefas.after.insert(function (userId, doc) {
    // ...
});
...
AtividadesTarefas.after.update(function (userId, doc, fieldNames, modifier, options) {
    // ...
...
// this.transform() obtains transformed version of document, if a transform was defined.
AtividadesTarefas.after.remove(function (userId, doc) {
    // ...
});
...
AtividadesTarefas.before.find(function (userId, selector, options) {
    // ...
});
...
AtividadesTarefas.after.find(function (userId, selector, options, cursor) {
    // ...
});
...
// Allows you to to adjust selector/options on-the-fly.
AtividadesTarefas.before.findOne(function (userId, selector, options) {
    // ...
});
...
AtividadesTarefas.after.findOne(function (userId, selector, options, doc) {
    // ...
});