...
if (Meteor.isServer) {
    ...
    Meteor.publish("Categorias", function () {
        this.ready()
        return [
            Categorias.find({createdBy: this.userId})
        ]
...
Categorias.before.update(function (userId, doc, fieldNames, modifier, options) {
...
// this.transform() obtains transformed version of document, if a transform was defined.
Categorias.before.remove(function (userId, doc) {
    // ...
});
...
Categorias.before.upsert(function (userId, selector, modifier, options) {
    // modifier.$set = modifier.$set || {};
    // modifier.$set.modifiedAt = Date.now();
});
...
Categorias.after.insert(function (userId, doc) {
    // ...
});
...
Categorias.after.update(function (userId, doc, fieldNames, modifier, options) {
    // ...
...
// this.transform() obtains transformed version of document, if a transform was defined.
Categorias.after.remove(function (userId, doc) {
    // ...
});
...
Categorias.before.find(function (userId, selector, options) {
    // ...
});
...
Categorias.after.find(function (userId, selector, options, cursor) {
    // ...
});
...
// Allows you to to adjust selector/options on-the-fly.
Categorias.before.findOne(function (userId, selector, options) {
    // ...
});
...
Categorias.after.findOne(function (userId, selector, options, doc) {
    // ...
});