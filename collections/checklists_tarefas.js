CheckListsTarefas = new Mongo.Collection("CheckListsTarefas");

if (Meteor.isServer) {
    //
    Meteor.publish("checklist", function (tarefaId) {
        this.ready()
        return [
            CheckListsTarefas.find({tarefaId: tarefaId})
        ]
...
CheckListsTarefas.before.insert(function (userId, doc) {
    if (!doc.test) {
...
CheckListsTarefas.before.update(function (userId, doc, fieldNames, modifier, options) {
...
// this.transform() obtains transformed version of document, if a transform was defined.
CheckListsTarefas.before.remove(function (userId, doc) {
    // ...
});
...
CheckListsTarefas.before.upsert(function (userId, selector, modifier, options) {
    // modifier.$set = modifier.$set || {};
    // modifier.$set.modifiedAt = Date.now();
});
...
CheckListsTarefas.after.insert(function (userId, doc) {
    // ...
});
...
CheckListsTarefas.after.update(function (userId, doc, fieldNames, modifier, options) {
    // ...
...
// this.transform() obtains transformed version of document, if a transform was defined.
CheckListsTarefas.after.remove(function (userId, doc) {
    // ...
});
...
CheckListsTarefas.before.find(function (userId, selector, options) {
    // ...
});
...
CheckListsTarefas.after.find(function (userId, selector, options, cursor) {
    // ...
});
...
// Allows you to to adjust selector/options on-the-fly.
CheckListsTarefas.before.findOne(function (userId, selector, options) {
    // ...
});
...
CheckListsTarefas.after.findOne(function (userId, selector, options, doc) {
    // ...
});