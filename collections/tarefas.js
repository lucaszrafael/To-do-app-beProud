...
if (Meteor.isServer) {
    ...
    Meteor.publish("Tarefas", function () {
        this.ready()
        return [
            Tarefas.find({createdBy: this.userId})
        ]
    });
}
...
Tarefas.before.insert(function (userId, doc) {
    if (!doc.test) {
...
Tarefas.before.update(function (userId, doc, fieldNames, modifier, options) {
...
// this.transform() obtains transformed version of document, if a transform was defined.
Tarefas.before.remove(function (userId, doc) {
    // ...
});
...
Tarefas.before.upsert(function (userId, selector, modifier, options) {
    // modifier.$set = modifier.$set || {};
    // modifier.$set.modifiedAt = Date.now();
});
...
Tarefas.after.insert(function (userId, doc) {
    // ...
});
...
Tarefas.after.update(function (userId, doc, fieldNames, modifier, options) {
    // ...
...
// this.transform() obtains transformed version of document, if a transform was defined.
Tarefas.after.remove(function (userId, doc) {
    // ...
});
...
Tarefas.before.find(function (userId, selector, options) {
    // ...
});
...
Tarefas.after.find(function (userId, selector, options, cursor) {
    // ...
});
...
// Allows you to to adjust selector/options on-the-fly.
Tarefas.before.findOne(function (userId, selector, options) {
    // ...
});
...
Tarefas.after.findOne(function (userId, selector, options, doc) {
    // ...
});