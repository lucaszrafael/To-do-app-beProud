Router.route('editar_tarefa/:tarefaId', {
    ...
    // one we can do that here. See the Route Controller3 section for more info.
    // controller: 'CustomController',

    // If the template name is different from the route name you can specify it
    // explicitly here.
    template: 'form_tarefa',
    ...
    waitOn: function () {
        import "/client/templates/tarefa/form_tarefa/form_tarefa.js"
