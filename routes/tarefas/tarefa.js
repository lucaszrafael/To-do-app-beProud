Router.route('tarefa/:tarefaId', {
    ...
    subscriptions: function () {
        this.subscribe('Categorias').wait();
        this.subscribe('Tarefas').wait();
        this.subscribe('Anotacoes').wait();
        this.subscribe('AtividadesTarefas').wait();
        this.subscribe('checklist', this.params.tarefaId).wait();
    },
    ...
    waitOn: function () {
        import "/client/templates/tarefa/tarefa.js"
